...
import torch
from src.models.CiDPG import CiDP
...
class CiDParameters:
    ...
    # revin : bool = False
    # not_cd_info : bool = False


@dataclass
class CiDPGForecast(ForecastExp, CiDParameters):
    model_type: str = "CiDPG"
